<?php
namespace ArchivematicaConnector\Api\Adapter;
...
class ArchivematicaImportAdapter extends AbstractEntityAdapter
{
    public function getEntityClass()
    {
        return 'ArchivematicaConnector\Entity\ArchivematicaImport';
    }

    public function getResourceName()
    {
        return 'archivematica_imports';
    }

    public function getRepresentationClass()
    {
        return 'ArchivematicaConnector\Api\Representation\ArchivematicaImportRepresentation';
    }

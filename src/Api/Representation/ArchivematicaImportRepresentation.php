<?php
namespace ArchivematicaConnector\Api\Representation;

use Omeka\Api\Representation\AbstractEntityRepresentation;

class ArchivematicaImportRepresentation extends AbstractEntityRepresentation
{

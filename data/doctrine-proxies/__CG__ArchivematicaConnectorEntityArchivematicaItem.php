 ...
 */
class ArchivematicaItem extends \ArchivematicaConnector\Entity\ArchivematicaItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ArchivematicaItem $proxy) {

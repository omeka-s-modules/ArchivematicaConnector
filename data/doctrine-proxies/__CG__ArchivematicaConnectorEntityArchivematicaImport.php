...
namespace DoctrineProxies\__CG__\ArchivematicaConnector\Entity;


/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class ArchivematicaImport extends \ArchivematicaConnector\Entity\ArchivematicaImport implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ArchivematicaImport $proxy) {
